...
Compile natural language specifications (NLSpecs) describing Rails apps into DOT pipeline files executable by [attractor](https://github.com/aliciapaz/attractor-engine).
